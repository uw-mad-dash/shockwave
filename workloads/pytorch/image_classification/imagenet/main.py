...
def main():
    ...
    if args.master_addr is not None:
        ...
        #     socket_ifname = 'enps0f0' #if hostname != 'node1' else 'enp94s0f0'
        #     # socket_ifname = 'eno4'  # rdma nics
        # else:  # ec2
        #     socket_ifname = "ens3"
        # os.environ['NCCL_SOCKET_IFNAME'] = socket_ifname
        
        print("before ini process dist_url", args.dist_url, args.local_rank)
    ...
    if os.path.exists(checkpoint_path):
        if args.enable_gavel_iterator:
            ...
            # print("checkpoint in gavel iterator", checkpoint, args.local_rank)
        else:
